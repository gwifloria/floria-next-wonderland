...
export const PROSE_CLASS = [
  ...
  "prose-code:bg-neutral-100 prose-code:px-1 prose-code:py-0.5 prose-code:before:content-[''] prose-code:after:content-['']",
  "prose-pre:bg-neutral-950/90 prose-pre:text-neutral-100 prose-pre:rounded-lg prose-pre:p-0",
